/*write a update statement to update city as null for order ids :  CA-2020-161389 , US-2021-1569098*/
update orders 
set city=null 
...
/*(i)create the exams table with below script;
...
,(5,'Chemistry',79);
(ii)write a query to find students who have got same marks in Physics and Chemistry.*/
